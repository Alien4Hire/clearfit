        ...
        <Col lg={8} className="column_padding">
          <div className="d-flex flex-column gap-4">
            ...
            <span className="letter-spacing-2 text-justify">
              ...
              convallis aenean et. Sit amet mauris commodo quis imperdiet massa
              tincidunt nunc. Volutpat diam ut venenatis tellus in. Risus
              ultricies tristique nulla aliquet enim tortor. Pretium viverra
              ...
              commodo sed egestas egestas fringilla phasellus faucibus. Velit ut
              tortor pretium viverra. Aliquam purus sit amet luctus venenatis.
            </span>
          </div>
        </Col>
        <Col lg={4}>
